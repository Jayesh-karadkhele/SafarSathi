...
export default function Login() {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if ((result.userRole || '').toUpperCase() !== (userRole || '').toUpperCase()) {
        setError(`This account is registered as ${result.userRole}. Please switch to the ${result.userRole} tab.`);
        setLoading(false);
        return;
      }
      ...
      setTimeout(() => {
        if ((result.userRole || '').toUpperCase() === 'VENDOR') {
          navigate("/vendor");
        } else {
          navigate("/packages");
        }
