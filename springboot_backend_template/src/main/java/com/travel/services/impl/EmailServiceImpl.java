...
public class EmailServiceImpl implements EmailService {
    ...
    public void sendBookingConfirmation(User user, Bookings booking, byte[] invoicePdf) {
        try {
            ...
            String pkgName = (booking.getTrip() != null && booking.getTrip().getSelectedPackage() != null)
                    ? booking.getTrip().getSelectedPackage().getPackageName()
                    : (booking.getTrip() != null && booking.getTrip().getTripName() != null ? booking.getTrip().getTripName() : "Custom Trip");
            String travelDate = (booking.getTrip() != null && booking.getTrip().getStartDate() != null)
                    ? booking.getTrip().getStartDate().toString() : "TBD";
